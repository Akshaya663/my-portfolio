...
export const RESUME_DATA: ResumeData = {
  personal: {
    ...
    summary:
      "Software engineer and cybersecurity professional with 3.5+ years of hands-on experience delivering secure, scalable enterprise applications. At DXC Technology, I built and maintained mission-critical systems for MassMutual Insurance — developing full-stack solutions with .NET, C#, and SQL Server, optimizing legacy codebases, and leading agile ceremonies that kept cross-functional teams aligned and shipping on time. Now at Infor, I've transitioned into application security — performing SAST/DAST assessments, driving vulnerability remediation across development teams, and reducing third-party dependencies by improving scan turnaround processes. I bring a rare combination: I write production code AND I know how to break it. Whether it's architecting REST APIs, managing AWS infrastructure, automating CI/CD pipelines, or identifying security flaws before they reach production — I operate at the intersection of engineering and security with a product-first mindset. I thrive in fast-paced environments where I can own problems end-to-end, communicate technical complexity to non-technical stakeholders, and continuously raise the bar for code quality and team output.",
  },
  experience: [
    {
